...
#if (WIN32)
    set(XC16_DEFAULT_SEARCH_PATH "C:/Program Files/Microchip/xc16/v2.10/bin")
#endif()
...
file(GLOB_RECURSE XC16_C_COMPILER ${XC16_SEARCH_PATH}/xc16-gcc.exe)
if (XC16_C_COMPILER)
...
file(GLOB_RECURSE XC16_CXX_COMPILER ${XC16_SEARCH_PATH}/xc16-g++.exe)
...
file(GLOB_RECURSE XC16_AR ${XC16_SEARCH_PATH}/xc16-ar.exe)
if (XC16_AR)
    message("-- FindXC16: Found xc16-ar at ${XC16_AR}")
    set(CMAKE_AR ${XC16_AR})
endif()

file(GLOB_RECURSE XC16_OBJCOPY ${XC16_SEARCH_PATH}/xc16-objcopy.exe)
if (XC16_OBJCOPY)
    message("-- FindXC16: Found xc16-objcopy at ${XC16_OBJCOPY}")
    set(CMAKE_OBJCOPY ${XC16_OBJCOPY})
endif()

file(GLOB_RECURSE XC16_OBJDUMP ${XC16_SEARCH_PATH}/xc16-objdump.exe)
if (XC16_OBJDUMP)
    message("-- FindXC16: Found xc16-objdump at ${XC16_OBJDUMP}")
    set(CMAKE_OBJDUMP ${XC16_OBJDUMP})
endif()

file(GLOB_RECURSE XC16_BIN2HEX ${XC16_SEARCH_PATH}/xc16-bin2hex.exe)
if (XC16_BIN2HEX)
